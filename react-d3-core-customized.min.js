var ReactD3Core = function (modules) {
    ...
    var _extends = Object.assign || function (target) {
        ...
        _commonProps = __webpack_require__(3),
        _commonProps2 = _interopRequireDefault(_commonProps),
        ChartSvg = (__webpack_require__(4), function (_Component) {
    ...
    ! function (global, factory) {
        factory(exports, __webpack_require__(6), __webpack_require__(7), __webpack_require__(8), __webpack_require__(10), __webpack_require__(11), __webpack_require__(12), __webpack_require__(9))
        ...
        exports.version = version, exports.scaleBand = band, exports.scalePoint = point, exports.scaleIdentity = identity, exports.scaleLinear = linear, exports.scaleLog = log, exports.scaleOrdinal = ordinal, exports.scaleImplicit = implicit, exports.scalePow = pow, exports.scaleSqrt = sqrt, exports.scaleQuantile = quantile$1, exports.scaleQuantize = quantize, exports.scaleThreshold = threshold, exports.scaleTime = time, exports.scaleUtc = utcTime, exports.scaleCategory10 = category10,
            exports.scaleCategory20b = category20b, exports.scaleCategory20c = category20c, exports.scaleCategory20 = category20, exports.scaleCubehelix = cubehelix$1, exports.scaleRainbow = rainbow, exports.scaleWarm = warm, exports.scaleCool = cool, exports.scaleViridis = viridis, exports.scaleMagma = magma, exports.scaleInferno = inferno, exports.scalePlasma = plasma
    })
}, function (module, exports, __webpack_require__) {
    ! function (global, factory) {
        factory(exports)
    ...
    ! function (global, factory) {
        factory(exports, __webpack_require__(9))
    ...
    var _extends = Object.assign || function (target) {
        ...
        _react = __webpack_require__(2),
        _react2 = _interopRequireDefault(_react),
        _svg = __webpack_require__(1),
        _svg2 = _interopRequireDefault(_svg),
        _legend = __webpack_require__(15),
    ...
    var _extends = Object.assign || function (target) {
        ...
        _react = __webpack_require__(2),
        _d3Selection = (_interopRequireDefault(_react), __webpack_require__(16)),
        _d3Selection2 = _interopRequireDefault(_d3Selection),
        _d3Scale = __webpack_require__(5),
        _d3Scale2 = _interopRequireDefault(_d3Scale),
        _reactFauxDom = __webpack_require__(17),
    ...
    ! function (global, factory) {
        ...
        function customEvent(event1, listener, that, args) {
            var event0 = exports.event;
            event1.sourceEvent = exports.event, exports.event = event1;
            try {
    ...
    var Element = __webpack_require__(18),
        Window = __webpack_require__(30),
        core = __webpack_require__(31),
        anim = __webpack_require__(32),
        ReactFauxDOM = {
            Element: Element,
            defaultView: Window,
            mixins: {
    ...
    var React = __webpack_require__(2),
        styleAttr = __webpack_require__(19),
        querySelectorAll = __webpack_require__(20),
        camelCase = __webpack_require__(24),
        isString = __webpack_require__(25),
        isUndefined = __webpack_require__(26),
        assign = __webpack_require__(27),
        mapValues = __webpack_require__(28),
        styleCamelCase = __webpack_require__(29);
    ...
    var isContextXML, matchExpr, util = __webpack_require__(22),
    ...
    var Element = __webpack_require__(18),
        ...
        mixin = {
            componentWillMount: function () {
                this.connectedFauxDOM = {}, this.animateFauxDOMUntil = 0
            },
            connectFauxDOM: function (node, name) {
                return this.connectedFauxDOM[name] = "string" != typeof node ? node : new Element(node), setTimeout(this.drawFauxDOM), this.connectedFauxDOM[name]
            },
    ...
    var anim = {
        animateFauxDOM: function (duration) {
            this.animateFauxDOMUntil = Math.max(Date.now() + duration, this.animateFauxDOMUntil), this.fauxDOMAnimationInterval || (this.fauxDOMAnimationInterval = setInterval(function () {
                Date.now() < this.animateFauxDOMUntil ? this.drawFauxDOM() : this.stopAnimatingFauxDOM()
            }.bind(this), 16))
        },
        stopAnimatingFauxDOM: function () {
            this.fauxDOMAnimationInterval = clearInterval(this.fauxDOMAnimationInterval), this.animateFauxDOMUntil = 0
        },
    ...
    var _createClass = function () {
        ...
        _d3Selection = __webpack_require__(16),
        _d3Selection2 = _interopRequireDefault(_d3Selection),
        _reactFauxDom = __webpack_require__(17),
        _reactFauxDom2 = _interopRequireDefault(_reactFauxDom),
        _scale = __webpack_require__(4),
        Axis = function (_Component) {
            ...
            return _inherits(Axis, _Component), _createClass(Axis, [{
                ...
                value: function () {
                    ...
                    return "left" === tickOrient ? func = func.axisLeft(this._mkScale(this.props)) : "right" === tickOrient ? func = func.axisRight(this._mkScale(this.props)) : "top" === tickOrient ? func = func.axisTop(this._mkScale(this.props)) : "bottom" === tickOrient && (func = func.axisBottom(this._mkScale(this.props))), tickFormat && func.tickFormat(tickFormat), tickPadding && func.tickPadding(tickPadding), tickSizeOuter && func.tickSizeOuter(tickSizeOuter), tickSizeInner && func.tickSizeInner(tickSizeInner), tickValues && func.tickValues(tickValues), ticks && func.ticks.apply(null, ticks), func
                }
            }, {
                key: "_mkScale",
                value: function () {
                ...
                value: function () {
                    ...
                    if (axisDom.call(this._mkTickAxis()), showAxis || (axisDom.selectAll(".grid-axis .tick text").style("opacity", "0"), "gridx" !== type && "gridy" !== type || axisDom.selectAll(".grid-axis .domain").style("opacity", "0")), axisStyling && axisStyling.pathClassName) {
                    ...
                    else axisStyling && axisStyling.textClassName && axisText.attr("class", axisStyling.textClassName);
